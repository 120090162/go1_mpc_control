#ifndef GO1_CTRL_STATES_H
#define GO1_CTRL_STATES_H
...
{
public:
	// this init function sets all variables to that used in go1 controller
	Go1CtrlStates()
	{
		reset();
	}
	...
	void resetFromROSParam(ros::NodeHandle &_nh)
	{
		...
		kd_foot << go1_kd_foot_x, go1_kd_foot_x, go1_kd_foot_x, go1_kd_foot_x,
